...
const cases = [
  ...
  { id: "E", name: "duplicate approval is not coalesced", file: "proposals/application.ts", from: 'if (existing) return existing;',
    to: '// mutation: duplicate submission allowed', test: application, pattern: "double click Approve" },
